...
class GoalDetailView: UIView {
    ...
    private lazy var goalTitle: UILabel = createBlackSemiboldLabel(text: "Goal Title", size: 20, alignment: .center)
    ...
    private lazy var levelText: UILabel = createBlackRegularLabel(text: "Level", size: 12, alignment: .center)
    private lazy var levelNumber: UILabel = createGreenSemiboldLabel(text: "1", size: 30, alignment: .center)
    private lazy var expText: UILabel = createBlackRegularLabel(text: "Experience", size: 12, alignment: .left)
    private lazy var expNumber: UILabel = createBlackRegularLabel(text: "3/7", size: 12, alignment: .right)
    private lazy var healthText: UILabel = createBlackRegularLabel(text: "Health", size: 12, alignment: .left)
    private lazy var tableViewTitle: UILabel = createBlackSemiboldLabel(text: "Habit System", size: 18, alignment: .left)
